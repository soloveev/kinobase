 ...
 *
 *  Помощник пришёл из админки личного проекта, которой в этой версии нет; сюда он
 *  переехал 15.09.2026, потому что предмет у него — разбор адреса, а `parseStatus`
 *  с `parseSort` решали ту же задачу вручную, каждая своим текстом. */
