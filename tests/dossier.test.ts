...
// `specs/v15/tools/keys-check.py`, который агент запускает по своему файлу порции.
...
describe('блок ключей: словарь, состав и форма тела', () => {
  ...
  // вовсе: сторожил его только `specs/v15/tools/keys-check.py` по файлу порции, то есть
